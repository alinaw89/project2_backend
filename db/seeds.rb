...
CosmeticProduct.create!(name: "Eyeliner", brand: "Stila", color: "Black", price: 20.0, purchase_date: "2015/02/06", user: nawal, category: Category.find_by_name('Eyes'), image: @file)
...
CosmeticProduct.create!(name: "Velvet Matte Lip Pencil", brand: "Nars", color: "Walkyrie", price: 25.0, purchase_date: "2014/05/07", user: courtney, category: Category.find_by_name('Lips'), image: @file)
 ...
 CosmeticProduct.create!(name: "Mascara", brand: "Dior", color: "Jet Black", price: 35.0, purchase_date: "2013/01/06", user: nawal, category: Category.find_by_name('Eyes'), image: @file)
